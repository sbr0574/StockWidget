...
class Ui_SettingDialog(object):
    def setupUi(self, SettingDialog):
        ...
        self.btn_top.setGeometry(QRect(170, 25, 70, 26))
        icon2 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.GoUp))
        self.btn_top.setIcon(icon2)
        self.btn_top.setIconSize(QSize(12, 12))
        self.btn_top.setAutoDefault(False)
        self.btn_top.setFlat(True)
        ...
        self.btn_up_color.setMinimumSize(QSize(60, 25))
        ...
        self.btn_neutral_color.setMinimumSize(QSize(60, 25))
        ...
        self.btn_down_color.setMinimumSize(QSize(60, 25))
        ...
        self.btn_fg_color.setMinimumSize(QSize(60, 25))
        ...
        self.btn_bg_color.setMinimumSize(QSize(60, 25))
        ...
        self.btn_check_update.setGeometry(QRect(20, 74, 130, 26))
        ...
        self.btn_open_cache_dir.setGeometry(QRect(20, 282, 117, 26))
        ...
        self.label_data_state.setGeometry(QRect(20, 46, 501, 22))
        self.label_data_state.setStyleSheet(u"color: rgb(0,0,0)")
        self.btn_clear_watchlist = QPushButton(self.gb_about)
        self.btn_clear_watchlist.setObjectName(u"btn_clear_watchlist")
        self.btn_clear_watchlist.setGeometry(QRect(148, 282, 117, 26))
        self.btn_clear_watchlist.setAutoDefault(False)
        self.btn_clear_watchlist.setFlat(True)
        self.btn_reset_appearance = QPushButton(self.gb_about)
        self.btn_reset_appearance.setObjectName(u"btn_reset_appearance")
        self.btn_reset_appearance.setGeometry(QRect(276, 282, 117, 26))
        self.btn_reset_appearance.setAutoDefault(False)
        self.btn_reset_appearance.setFlat(True)
        self.btn_reset_settings = QPushButton(self.gb_about)
        self.btn_reset_settings.setObjectName(u"btn_reset_settings")
        self.btn_reset_settings.setGeometry(QRect(404, 282, 117, 26))
        self.btn_reset_settings.setAutoDefault(False)
        self.btn_reset_settings.setFlat(True)
    ...
    def retranslateUi(self, SettingDialog):
        ...
        self.btn_clear_watchlist.setText(QCoreApplication.translate("SettingDialog", u"\u6e05\u7a7a\u81ea\u9009\u5217\u8868", None))
#if QT_CONFIG(tooltip)
        self.btn_clear_watchlist.setToolTip(QCoreApplication.translate("SettingDialog", u"\u6e05\u9664\u6240\u6709\u81ea\u9009\u6761\u76ee\u53ca\u6210\u672c", None))
#endif // QT_CONFIG(tooltip)
        self.btn_reset_appearance.setText(QCoreApplication.translate("SettingDialog", u"\u6062\u590d\u9ed8\u8ba4\u5916\u89c2", None))
#if QT_CONFIG(tooltip)
        self.btn_reset_appearance.setToolTip(QCoreApplication.translate("SettingDialog", u"\u6062\u590d\u989c\u8272\u3001\u900f\u660e\u5ea6\u3001\u5b57\u4f53\u3001\u884c\u8ddd\u3001\u8868\u5934\u3001\u7f51\u683c\u548c\u56fe\u6807", None))
#endif // QT_CONFIG(tooltip)
        self.btn_reset_settings.setText(QCoreApplication.translate("SettingDialog", u"\u6062\u590d\u9ed8\u8ba4\u8bbe\u7f6e", None))
#if QT_CONFIG(tooltip)
        self.btn_reset_settings.setToolTip(QCoreApplication.translate("SettingDialog", u"\u6062\u590d\u5237\u65b0\u95f4\u9694\u3001\u6570\u636e\u6e90\u3001\u6307\u6807\u3001\u529f\u80fd\u5f00\u5173\u548c\u5feb\u6377\u952e", None))
#endif // QT_CONFIG(tooltip)
